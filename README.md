...
<p>
    <strong>TL;DR:</strong> <a href="https://docs.python.org/3/library/concurrent.futures.html"><code>concurrent.futures</code></a>-like simplicity
    for concurrently running <a href="https://www.datacamp.com/blog/what-is-a-dag">DAGs</a> of tasks
    with configuration permutations across threads, processes, or clusters with implicit result caching.
</p>
